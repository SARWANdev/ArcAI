...
vector_store = ai_service.get_vector_store(text_chunks=text_chunks, embedding_path="tests")
loaded_vs = ai_service.load_vector_store_from_path(embedding_path="tests")
print(vector_store)
print(loaded_vs)