 ...
 */
export default function PageLayout({ children, headerRight, className = "", style = {} }) {
  return (
    <div className="container-fluid vh-100 d-flex flex-column p-0 overflow-hidden">
      ...
      <div className="row flex-grow-1 g-0 mx-0 flex-column flex-md-row" style={{ overflow: 'hidden' }}>
        {/* Sidebar - Stacks on top on small screens, adjusts to width automatically on medium+ */}
        <div className="col-12 col-md-auto h-100" style={{ overflow: 'hidden' }}>
          <Sidebar />
        </div>
        {/* Content Area - Takes full width on small screens, adjusts to sidebar on medium+ */}
