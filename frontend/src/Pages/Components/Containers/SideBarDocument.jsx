...
import { FaBook, FaComments, FaArrowLeft } from "react-icons/fa"; // Import FaArrowLeft for the back button
 ...
 */
export const SidebarDocument = ({projectId, projectTitle}) => {
  ...
  const goToProject = (e) => {
    e?.preventDefault();
    navigate(`/home/library/project/${projectId}/${projectTitle}`, { replace: true });
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={goToProject} style={buttonBaseStyle}>
          <FaArrowLeft style={{ width: 32, height: 32 }} />
          {isExpanded && (
            <span className="ms-3" style={{ fontSize: "1rem" }}>
              Back to Project
            </span>
