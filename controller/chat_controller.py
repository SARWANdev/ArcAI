...
class ChatController:
    ...
    def query(self):
        try:
            ...
            print(1)
            new_conversation = self.conversation_service.create_conversation(user_id=user_id, document_ids=document_ids, project_ids=project_ids)
            print(2)
            new_conversation.add_user_message(user_prompt)
            print(3)
            self.conversation_service.update_name(new_conversation.conversation_id, self.ai_service.generate_conversation_name(new_conversation))
